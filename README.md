...
This repository creating mini projects using React.Content is 'Manipulating Text using CSS'(TextAnimation).
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/kirthi1594/Celebrare.git
   ```
...
You can customize this TextAnimation according to your needs.
